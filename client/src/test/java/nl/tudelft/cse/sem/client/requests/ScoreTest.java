...
class ScoreTest {
    ...
    @Test
    void scoreSendSuccessful() {

        server.enqueue(new MockResponse()
                .setResponseCode(200).setBody("{\"message\" : \"laura\"}"));
        Optional<String> res = new Score(username, 42, retrofit).makeCall();
    ...
    void invalidScore() {
        ...
        Optional r2 = new Score(username, -42, retrofit).makeCall();
    ...
    @SuppressWarnings("PMD.DataflowAnomalyAnalysis")
    void ioexception() {
        Optional<String> r2 = new Score(username, 22, new Retrofit.Builder()
